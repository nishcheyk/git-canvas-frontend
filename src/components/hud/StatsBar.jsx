import { ArrowLeft, Star, Code, FolderGit } from 'lucide-react';

/**
 * Top HUD navigation overlay showing aggregate statistics and quick exit controls.
 */
export default function StatsBar({ onBack, stats, user }) {
  return (
    <div className="absolute top-4 left-4 right-4 z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-3 pointer-events-none select-none">
      ...
      <div className="flex items-center gap-2.5 pointer-events-auto">
        <button
          ...
          className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#080818]/70 border border-[#1b1b3a] hover:border-indigo-500/80 hover:text-indigo-400 text-gray-100 transition-all cursor-pointer backdrop-blur-md shadow-lg"
        >
      ...
      <div className="flex items-center gap-5 px-5 py-2 rounded-xl bg-[#080818]/70 border border-[#1b1b3a] backdrop-blur-md shadow-lg pointer-events-auto w-fit">
        {/* Star aggregate */}
